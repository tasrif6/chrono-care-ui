...
const Dashboard = () => {
  const stats = [
    { title: 'Total Patients', value: 2482, icon: User },
    { title: 'Total Doctors', value: 120, icon: DollarSign },
    { title: 'Total Wards', value: 300, icon: ShoppingCart },
    { title: 'Total Labs', value: 40, icon: Activity },
  ];
  ...
  const handleStatusChange = (id, newStatus) => {
    ...
    const chartData = [
    { Patients: 20, Doctors: 15 },
    { Patients: 25, Doctors: 20 },
    { Patients: 18, Doctors: 17 },
    { Patients: 30, Doctors: 22 },
    { Patients: 24, Doctors: 19 },
    { Patients: 28, Doctors: 25 },
    ];
        ...
        <nav className="flex-1 p-4 space-y-2">
            ...
            <button
                ...
                onClick={() => { setActiveTab(item.name);
                    ...
                    if (item.name === 'Patient') navigate('/patientdashboard'); 
                    if (item.name === 'Blood Bank') navigate('/bloodbank');
                    if (item.name === 'Staff') navigate('/staff');
                    if (item.name === 'Lab') navigate('/lab');
                    if (item.name === 'Treatment') navigate('/treatment');
            ...
            {/* Add this inside your sidebar, after the navigation */}
            <div className="mt-auto p-4 border-t border-purple-600">
              <Button
                className="w-full bg-white text-black hover:bg-red-600 hover:text-white border border-gray-300 my-40 mb-10"
                onClick={() => {
